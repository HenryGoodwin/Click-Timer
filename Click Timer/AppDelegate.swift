...
extension UIColor {
    static func Blue() -> UIColor {
        return UIColor(red: 46.0/255.0, green: 135.0/255.0, blue: 195.0/255.0, alpha: 1.0)
    }
    ...
    static func Orange() -> UIColor {
        ...
        return UIColor(red: 255.0/255.0, green:127.0/255.0, blue: 0/255.0, alpha: 1.0)
    }
    
    static func GrayBG() -> UIColor {
        
        return UIColor(red: 238.0/255.0, green: 242.0/255.0, blue: 245.0/255.0, alpha: 1.0)
    }
    
    static func Purple() -> UIColor {
        
        return UIColor(red: 115.0/255.0, green: 89.0/255.0, blue: 182.0/255.0, alpha: 1.0)
    }
